 ...
 */
public class DelegateMutableLiveData<T> extends MutableLiveData<T> {

    private MutableLiveData<T> delegate;
    private static Field mVersion;

    public DelegateMutableLiveData(MutableLiveData<T> delegate) {
    ...
    private void correctVersioning() {
        ...
        Timber.d("Versioning corrected for LiveData = %s", DelegateMutableLiveData.this.toString());
        // [END]
    }
